...
#def add_status():
 #menu_choice = str.lower(raw_input("Do you want to select from the older status (Y/N)?"))
 #if (menu_choice) == "y":
    #my_list = ["1.hey!'there i am using spy chat", "2.Sleeping Time","3.at college time"]
    #for temp in my_list:
        #print temp
    #show_menu=True
    #while show_menu:
        ...
        #if menu_choice==1:
          #print("hey!'there i am using spy chat")
        #elif(menu_choice==2):
             #print("sleeping time")
 #else:
     #new_status_message = raw_input("what status message do you want to set")
        ...
        #for message in current_status_message:
            #print message
from Spydetail import spy,friends
from steganography.steganography import Steganography
from datetime import datetime
from Spydetail import friends
